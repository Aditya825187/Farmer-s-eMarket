...
public class HomeFragment extends Fragment {
    ...
    private CatagoryAdoptor catagoryAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        catagoryModelList.add(new CatagoryModel("link","Vegetables"));
        catagoryModelList.add(new CatagoryModel("link","Fruits"));
        catagoryModelList.add(new CatagoryModel("link","Milk"));

        catagoryAdapter = new CatagoryAdoptor(catagoryModelList);
